...
export class Credits extends Scene {
    constructor() {
        ...
        this.creditsText = [
            ...
            'JunKys59 - Master of Disaster Recovery',
            '',
            'Game Director',
            'FeadHD',
            ...
            'JunKys59 - VFX Programming (Explosions go boom)',
            '',
            'Gameplay Systems Architecture',
            'simon grenier - Lead Architect of Spaghetti Code',
            'Gray - Systems Designer (Professional Stack Overflow Navigator)',
            'FeadHD - Core Mechanics (Certified Bug Habitat Designer)',
            '',
            'Combat Design Specialists',
            'JunKys59 - Melee Systems (Button Masher Extraordinaire)',
            'FeadHD - Weapon Balance (Nerfing Things Since 2024)',
            'Gray - Enemy AI (Teaching NPCs to be less artificial and more intelligent)',
            '',
            'Environmental Art Team',
            'simon grenier - Lead Artist (Professional Tree Painter)',
            'Gray - Level Artist (Specialized in Placing Rocks)',
            'JunKys59 - Prop Artist (Master of Creating Things Players Break)',
            '',
            'Character Animation Squad',
            'FeadHD - Animation Director (Makes Things Move Good)',
            'Gray - Technical Animator (Fixes Things That Move Bad)',
            '',
            'Narrative Design & Writing',
            'simon grenier - Lead Writer (Professional Plot Hole Filler)',
            'JunKys59 - Dialogue Writer (Semicolon Enthusiast)',
            '',
            'Performance Optimization',
            'Gray - Lead Optimizer (Can make any code run at 2 FPS)',
            'FeadHD - Memory Management (Professional RAM Whisperer)',
            '',
            'Platform Integration',
            'simon grenier - Cross-Platform Lead (Makes Square Pegs Fit Round Holes)',
            'JunKys59 - Console Specialist (Knows Where All The Buttons Are)',
            '',
            'Build Engineering',
            'Gray - Build Master (Professional "Works On My Machine" Engineer)',
            'FeadHD - Pipeline Tools (Plumber of the Code Rivers)',
            '',
            'DevOps & Infrastructure',
            'simon grenier - CI/CD Lead (Continuous Chaos/Disaster)',
            'JunKys59 - Cloud Architecture (Head of Meteorology Department)',
            '',
            'Quality Assurance',
            'Lead QA',
            ...
            '',
            'QA Team Leads',
            'FeadHD - Gameplay Testing (Professional Game Breaker)',
            'simon grenier - Performance Testing (Crash Test Dummy)',
            'JunKys59 - Platform Compatibility (Works in 60% of cases, every time)',
            '',
            'Player Experience Research',
            'Gray - Research Lead (Studies Why Players Keep Dying)',
            'FeadHD - Data Analysis (Counts Deaths Per Second)',
            '',
            'UI/UX Design Team',
            'simon grenier - UI Lead (Button Alignment Specialist)',
            'JunKys59 - UX Specialist (Makes Clicking Things Feel Clicky)',
            '',
            'Audio Production',
            '',
            'Audio Director',
            ...
            '',
            'Sound Design',
            'FeadHD - Weapon Effects (Professional Boom Maker)',
            'JunKys59 - Environmental (Recorded actual keyboard typing for authenticity)',
            '',
            'Music Composition',
            'simon grenier - Lead Composer (Mostly Elevator Music)',
            'Gray - Additional Music (Humming in the Background)',
            '',
            'Voice Acting Director',
            'FeadHD (Chief Microphone Tester)',
            '',
            'Voice Talent',
            'Gray as "The Hero" (Recorded All Lines During Meetings)',
            'FeadHD as "The Villain" (Method Actor, Actually Became Evil)',
            'simon grenier as "The Mentor" (Actual Debugging Sessions Recorded)',
            'JunKys59 as "The Mysterious Stranger" (Just Some Guy We Found)',
            '',
            'Motion Capture Studio',
            'Gray - Mocap Director (Professional Dance Move Copier)',
            'FeadHD - Technical Director (Puts Dots On People)',
            'simon grenier - Animation Clean-up (Digital Janitor)',
            '',
            'Localization Teams',
            '',
            'French Team',
            'simon grenier - Lead (Omelette du Fromage Department)',
            '',
            'Japanese Team',
            'JunKys59 - Lead (Studied Anime for Research)',
            '',
            'Marketing & PR',
            '',
            ...
            '',
            'Regional Marketing',
            'FeadHD - North America (Knows All 50 States... Almost)',
            'simon grenier - Europe (Can Point to France on a Map)',
            'JunKys59 - Asia (Has Eaten Authentic Instant Ramen)',
            '',
            'Social Media Team',
            'Gray - Strategy (Professional Tweet Deleter)',
            'FeadHD - Content (Meme Archaeologist)',
            '',
            'Community Management',
            'simon grenier - Lead CM (Professional Drama Diffuser)',
            'JunKys59 - Forum Moderator (Survived The Flame Wars)',
            '',
            'Player Support',
            'Gray - Support Lead (Professional "Have You Tried Turning It Off And On Again?" Specialist)',
            'FeadHD - Technical Support (Can Read Error Logs... Sometimes)',
            '',
            'Legal Team',
            'Gray & Associates',
