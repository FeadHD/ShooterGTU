...
export class GameScene5 extends BaseScene {
    ...
    preload() {
        ...
        // Load tileset
        this.load.image('tileset-map-5', 'assets/levels/image/TileSet v1.0.png');
        
        // Load level data
        this.load.json('level5', '/assets/levels/Json/Level_Map_5.json');
    }
    ...
    create() {
        ...
        const levelData = this.cache.json.get('level5');
        ...
        // Add tileset to map
        const tileset = map.addTilesetImage('tileset-map-5', 'tileset-map-5', 32, 32, 0, 0);
        ...
        placeTilesPromise.then(() => {
            ...
            this.time.delayedCall(100, () => {
                // Add bullet collisions with platforms
        ...
        for (let i = 0; i < 10; i++) {
            ...
            const heightFactor = Math.abs(i - 4.5) / 4.5;
            const y = baseY - (maxHeight * (1 - heightFactor));
