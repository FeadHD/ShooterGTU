...
export class BlueTest extends BaseScene{
    constructor() {
        super({ 
            key: 'BlueTest',
    ...
    preload() {
        ...
        this.load.spritesheet('megapixel', '/assets/levels/image/Platform_blue.png', {
            frameWidth: 32,
            frameHeight: 32,
            spacing: 0,
            margin: 0
        ...
        this.load.json('matrix', '/assets/levels/Json/Bleu_platform.json');
        ...
        // Load enemy assets if not already loaded
    ...
    create() {
        ...
        WebFont.load({
            ...
            active: () => {
                ...
                const platformLayer = levelData.layerInstances.find(layer => layer.__identifier === "Platform_Blue");
                ...
                // Get the layer instance for Platform_blue layer
                const tileLayer = levelData.layerInstances.find(layer => layer.__identifier === "Platform_blue");
        
                if (!tileLayer) {
                    console.error('Platform_bluelayer not found');
                    return;
                }
